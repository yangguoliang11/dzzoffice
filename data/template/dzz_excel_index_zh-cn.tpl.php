<?php if(!defined('IN_DZZ')) exit('Access Denied'); /*a:7:{s:61:"D:\phpstudy_pro\WWW\dzzoffice\/./dzz/excel/template/index.htm";i:1586240937;s:85:"D:\phpstudy_pro\WWW\dzzoffice\/./core/template/default/common/header_simple_start.htm";i:1586239670;s:83:"D:\phpstudy_pro\WWW\dzzoffice\/./core/template/default/common/header_simple_end.htm";i:1586239670;s:79:"D:\phpstudy_pro\WWW\dzzoffice\/./core/template/default/common/commer_header.htm";i:1586239670;s:67:"D:\phpstudy_pro\WWW\dzzoffice\/./dzz/excel/template/header_left.htm";i:1586240937;s:69:"D:\phpstudy_pro\WWW\dzzoffice\/./dzz/excel/template/header_search.htm";i:1586240937;s:78:"D:\phpstudy_pro\WWW\dzzoffice\/./core/template/default/common/header_right.htm";i:1586239670;}*/?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="./data/template/dzz_excel_index_index_zh-cn.js" ></script><script type="text/javascript" src="<?php echo MOD_PATH;?>/scripts/index.js?<?php echo VERHASH;?>" ></script>
...
</style><script type="text/javascript" src="./data/template/dzz_excel_index_common_zh-cn.js" ></script><script type="text/javascript" src="static/js/common.js?<?php echo VERHASH;?>" ></script>
</head>
...
<div class="bs-container clearfix" style="height: 100%">
            ...
            <div class="template-wrap" style="<?php if(!$setting['tplhide']) { ?>height: 0px;position:fixed;top: 64px;<?php } ?>">
                <div class="temp-top clearfix">
                    <div class="topwrap clearfix">
                        ...
                        <?php if($_G['adminid']) { ?><a href="<?php echo MOD_URL;?>&op=tplmanage" class="manage"><i class="dzz dzz-create"></i> <?php echo lang('tpl_manage')?></a><?php } ?>
                    </div>
    ...
    <div id="publish_stick" class="m-g H" style="<?php if(!$setting['tplhide']) { ?>display: block;<?php } ?>">
        ...
        <div class="vc">
            <?php if($_G['adminid']) { ?>
                <div class="V">
                    <a class="r nX file-btn" href="<?php echo MOD_URL;?>&op=tplmanage"><i class="dzz dzz-dashboard" style="opacity: 1"></i></a>
                    <label class="bA lN">
            ...
            jQuery.each(data.files, function (index, file) {
                if(!file.name) file.name='new.xls';
                    ...
                    if(jQuery.inArray(file.type, type_arr) < 0){
                        showmessage('<?php echo lang(chose_xls_file)?>', 'error', 1000, 1);
                        return;
                    }
            });
...
<script type="text/javascript" src="./data/template/dzz_excel_index_jquery_fileupload-validate_zh-cn.js" ></script><script type="text/javascript" src="static/jquery_file_upload/jquery.fileupload-validate.js?<?php echo VERHASH;?>" ></script>